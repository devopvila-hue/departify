...
export const RUNTIME_CAPABILITY_RULES: readonly CapabilityRule[] = [
  ...
  { id: "drive.create_folder", sourceCapabilities: ["drive.create_folder"] },
  { id: "drive.create_file", sourceCapabilities: ["drive.create_file"] },
  { id: "drive.write", sourceCapabilities: ["drive.write"] },
