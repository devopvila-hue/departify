...
export function renderRuntimeBusinessContextForEngine(
  ...
  return [
    ...
    "- GitHub repository access: Check the tool list for github.repos.list and github.repos.inspect. If listed, the CEO can list and inspect repositories. If not listed, GitHub is not connected.",
