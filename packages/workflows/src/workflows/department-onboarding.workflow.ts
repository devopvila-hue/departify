 ...
 *
 *  1. briefing    — Director (agent_sales_director) reads the discovery report (discovery.get)
 ...
 * `organizationId` and `employeeAgentId` (the delegated employee that
 * received the highest-priority item).
 */
...
export const DEPARTMENT_ONBOARDING_WORKFLOW =
  buildDepartmentOnboardingWorkflow("org_default", "agent_lead_qualifier");
